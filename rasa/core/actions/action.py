...
ACTION_SUMMARIZE_WITH_PASSAGE = "action_summarize_with_passage"
...
class ActionSummarizeWithPassage(Action):
    """Retrieves a selected passage based on sentiment analysis"""

    def name(self) -> Text:
        return ACTION_SUMMARIZE_WITH_PASSAGE
    
    def choose_passage(self, theme):
        d = {'happiness': [
         ...
         ('"I don’t let anyone touch me,” I finally said. Why not?” Why not? Because I was tired of men. Hanging in doorways, standing too close, their smell of beer or fifteen-year-old whiskey. Men who didn\’t come to the emergency room with you, men who left on Christmas Eve. Men who slammed the security gates, who made you love them then changed their minds. Forests of boys, their ragged shrubs full of eyes following you, grabbing your breasts, waving their money, eyes already knocking you down, taking what they felt was theirs. (…) It was a play and I knew how it ended, I didn\’t want to audition for any of the roles. It was no game, no casual thrill. It was three-bullet Russian roulette.”',
          'Janet Fitch',
          'White Oleander'),
         ('Try this for deviancy: fabricants are mirrors held up to purebloods\' conscience; what purebloods see reflected there sickens them. So they blame you for holding the mirror." I hid my shock by asking when purebloods might blame themselves."',
          'David Mitchell',
          'Cloud Atlas'),
    ...
    async def run(
        ...
        for e in tracker.events:
            ...
            if 'parse_data' in d:
                ...
                if 'intent' in p:
                    n = p['intent']['name']
                    if n in {'nervous', 'fear', 'anger', 'happiness', 'surprise', 'sadness', 'love', 'anticipation', 'disgust'}:
                        if n in b:
                            b[n] += 1
                        else:
                            b[n] = 1
        if len(b) > 0:
            ...
            print('chosen sentiment: {}'.format(p[0]))
...
class ActionDefaultAskAffirmation(Action):
    ...
    async def run(
        ...
        affirmation_message = f"This conversation seems '{intent_to_affirm}'?"
